...
This process will generate a long-lasting refresh token and ideally will never have to be repeated. The config file generated by `baton auth` will be created in `$HOME/.config/baton.json`
